...
class ConfiguracionSitio(models.Model):
    nombre_marca     = models.CharField(max_length=100, default='KRUXEL')
    ...
    email_contacto   = models.EmailField(default='contacto@kruxel.cl')
    ...
    instagram_usuario= models.CharField(max_length=100, blank=True, default='@kruxel')
    facebook_url     = models.URLField(blank=True, default='https://facebook.com/kruxel')
    facebook_usuario = models.CharField(max_length=100, blank=True, default='KRUXEL')
    ...
    nosotros_texto1  = models.TextField(default='En KRUXEL creamos experiencias gastronómicas únicas para cada celebración. Desde bodas íntimas hasta grandes eventos corporativos, nuestra cocina combina técnica de alta cocina con ingredientes locales de temporada.')
